...
private:
    ...
    {
        static constexpr std::array<int, sizeof...(Chars)> m_arrValue = {HexStringToInteger<Chars>::m_nValue...};
    };
    ...
    {
#ifdef SIGTOARR_USE_LOOKUP_TABLE
        static constexpr int m_nValue = details::SigToArr::ASCIIHexToInter[Char];
#else
